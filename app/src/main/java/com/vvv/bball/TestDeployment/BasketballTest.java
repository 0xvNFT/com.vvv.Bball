...
//
//
//    public BasketballTest(Resources res, float screenX, float screenY) {
//        this.screenX = screenX;
//        this.screenY = screenY;
//
//        // BasketballTest court: 28m long  ->  screenX = half a basketball court ( 14m )
...
//
//        initialX = x + width / 2f;
//        initialY = y + height / 2f; // This is needed because the object:BasketballTest is only initialized once.
//
//        orgIX = initialX;
//        orgIY = initialY;
//
...
//    {
//        return (float) (Math.atan2(initialY - Ty, initialX - Tx));
...
//    {
//        thrown = false; // also resets time in: GameViewTest.java -> sleep() -> if (ball.thrown) !|-> else {ball.time = 0;}
//        collision = 0; // = no collision.
//        colX = 0;
//        colY = 0;
//
